...
function societe_ordinaire_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'societe_ordinaire/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'societe_ordinaire'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['page_container']['page_container_border'] = array(
    ...
    '#default_value' => theme_get_setting('page_container_border', 'societe_ordinaire'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['header']['fixed_header'] = array(
    ...
    '#default_value' => theme_get_setting('fixed_header', 'societe_ordinaire'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_display'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_display', 'societe_ordinaire'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_icon'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_icon','societe_ordinaire'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_region'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_region', 'societe_ordinaire'),
    '#options' => array(
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (societe_ordinaire/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'societe_ordinaire'),
    '#options' => array(
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['premium_description'] = array(
   ...
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-01-looknfeel.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-02-region.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['post_tab']['post']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-03-article.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['layout_tab']['layout_modes']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-04-layout.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['font_tab']['font']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-05-fonts.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-06-slideshow.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['video_bg_tab']['video_bg']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-07-videobackground.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['isotope_tab']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-08-isotope.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['google_maps_tab']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium-09-googlemaps.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['premium_tab']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'societe_ordinaire') . '/images/premium.jpg" />
   </a></div> ',
  );
